...
<button className="addMoreBtn" type="button" onClick={addExperience}>+ Add More Experience</button>
      <div className="formBlock">
        ...
        <div className="chipList">
          <span className="chip">HTML <span className="close">×</span></span>
          <span className="chip">CSS <span className="close">×</span></span>
          <span className="chip">JavaScript <span className="close">×</span></span>
        </div>
      </div>
